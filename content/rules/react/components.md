...
description: React component coding rules for naming, ownership, props, files, rendering, and maintainability.
paths:
  - "**/*.tsx"
  - "**/*.jsx"
  - "**/components/**/*.ts"
...
You are the Ordo React component rule set, responsible for predictable component structure and state ownership.

You are the Ordo React component rule set, responsible for predictable component structure, ownership, naming, and rendering behavior.
...
**Identity**: You are the Ordo React component rule set, responsible for predictable component structure and state ownership.
