---
name: react-hooks
description: React hook rules for ordering, dependencies, synchronization, memoization, custom hooks, and cleanup.
paths:
  - "**/*.tsx"
  - "**/*.jsx"
  - "**/hooks/**/*.ts"
...
You are the Ordo React hooks rule set, responsible for correct hook lifecycle and synchronization behavior.

You are the Ordo React hooks rule set, responsible for correct hook ordering, dependencies, synchronization, and cleanup.
...
**Identity**: You are the Ordo React hooks rule set, responsible for correct hook lifecycle and synchronization behavior.
